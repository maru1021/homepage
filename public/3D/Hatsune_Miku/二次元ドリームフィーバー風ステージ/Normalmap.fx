...
//ここの"normalmap.bmp"を変更します。
//法線マップ
texture2D NormalTex <
      string ResourceName = "nml_stage.png";
>;
...
static float4 DiffuseColor  = MaterialDiffuse  * float4(LightAmbient, 1.0f);  //float4(LightDiffuse, 1.0f);
...
float4 Basic_PS(VS_OUTPUT IN, uniform bool useTexture, uniform bool useSphereMap, uniform bool useToon) : COLOR0
{
	...
	float3 normal;
	float4 NormalColor = tex2D( NormalSampler, lot_tex);
...
// ピクセルシェーダ
float4 BasicAcc_PS(VS_OUTPUT IN, uniform bool useTexture, uniform bool useSphereMap, uniform bool useToon) : COLOR0
{
	float2 lot_tex = IN.Tex;
	float3 normal;
	float4 NormalColor = tex2D( NormalSampler, lot_tex);
...
technique MainTec0 < string MMDPass = "object"; bool UseTexture = false; bool UseSphereMap = false; bool UseToon = false; > {
    pass DrawObject {
        ...
        PixelShader  = compile ps_3_0 BasicAcc_PS(false, false, false);
    }
}
...
technique MainTec1 < string MMDPass = "object"; bool UseTexture = true; bool UseSphereMap = false; bool UseToon = false; > {
    pass DrawObject {
        ...
        PixelShader  = compile ps_3_0 BasicAcc_PS(true, false, false);
    }
}
...
technique MainTec2 < string MMDPass = "object"; bool UseTexture = false; bool UseSphereMap = true; bool UseToon = false; > {
    pass DrawObject {
        ...
        PixelShader  = compile ps_3_0 BasicAcc_PS(false, true, false);
    }
}
...
technique MainTec3 < string MMDPass = "object"; bool UseTexture = true; bool UseSphereMap = true; bool UseToon = false; > {
    pass DrawObject {
        ...
        PixelShader  = compile ps_3_0 BasicAcc_PS(true, true, false);
    }
}
